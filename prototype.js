...
function prototypeViewMarkup(view) {
  if (view === 'Packs') return `<section class="workspace-card"><p>RISING ICONS</p><h3>Build your collection.</h3><span>Every Rising Icons pack costs 28 Coins.</span><button data-prototype-open-pack>OPEN RISING ICONS PACK <b>28 COINS</b></button><small>Top pulls include Neymar Jr, Vini Jr, Bellingham, and Yamal.</small></section>`;
...
function openPrototypePack() {
  ...
  if (points < cost) {
    showPrototypeToast('You need 28 Coins to open this pack.');
    return;
  }
